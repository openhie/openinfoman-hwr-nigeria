...
let $provs2 := if (exists($careServicesRequest/requestParams/credential/codedType/@code) and exists($careServicesRequest/requestParams/credential/codedType/@codingScheme) ) then $provs1  else ()
let $cred_new := $careServicesRequest/requestParams/credential
